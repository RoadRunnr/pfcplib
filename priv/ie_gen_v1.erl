...
ies() ->
    [
     ...
     {38, "Redirect Information",
      [{'_', 4},
       ...
       %% this not strictly correct, but good enough for now
	...
	{'_', 0}]},
     ...
     {95, "Outer Header Removal",
      [{"Header", 8, {enum, [{0, "GTP-U/UDP/IPv4"},
			     ...
			     {8, "S-TAG and C-TAG"}]}},
       {'_', 7},
       {"PDU Session Container", 1, integer},
       {'_', 0}]},
     ...
     {152, "Trace Information",
      [{"MCCMNC", 24, {type, v1_mccmnc}},
       ...
       {'_', 0}]},
     {153, "Framed-Route",
      [{"Framed-Route", 0, binary}]},
     {154, "Framed-Routing",
      [{"Framed-Routing", 32, integer}]},
     {155, "Framed-IPv6-Route",
      [{"Framed-IPv6-Route", 0, binary}]},
     {156, "Event Time Stamp",
      [{"Time", 32, integer},
       {'_', 0}]},
     {157, "Averaging Window",
      [{"Averaging Window", 32, integer},
       {'_', 0}]},
	...
	{enum, [{0, "S1-U"},
     ...
     {171, "Steering Functionality",
      [{'_', 4},
       {"Steering Functionality", 4, {enum, [{0, "ATSSS-LL"},
					     {1, "MPTCP"}]}},
       {'_', 0}]},
     {172, "Steering Mode",
      [{'_', 4},
       {"Steering Mode", 4, {enum, [{0, "Active-Standby"},
				    {1, "Smallest Delay"},
				    {2, "Load Balancing"},
				    {3, "Priority-based"}]}},
       {'_', 0}]},
     ...
     {174, "Priority",
      [{'_', 4},
       {"Priority Value", 4, {enum, [{0, "Active"},
				     {1, "Standby"},
				     {2, "High"},
				     {3, "Low"}]}},
       {'_', 0}]},
     ...
     {177, "UE IP address Pool Identity",
      [{"Identity", 0, binary}]},
     {178, "Alternative SMF IP Address", smf_ip_address},

     {{18681, 1}, "TP Packet Measurement", volume_threshold},
     {{18681, 2}, "TP Build Id",
      [{"Id", 0, binary}]},
     {{18681, 3}, "TP Now",
      [{"Now", 64, {type, sntp_timestamp}}]},
     {{18681, 4}, "TP Start",
      [{"Start", 64, {type, sntp_timestamp}}]},
     {{18681, 5}, "TP Stop",
      [{"Stop", 64, {type, sntp_timestamp}}]}
    ].
...
msgs() ->
	...
	[{"Application ID",			   'M', {'-', 'X', 'X', 'X'}},
     ...
     {6, "Association Setup Response",			{'X', 'X', 'X', 'X'},
      [{"Node ID",				   'M', {'X', 'X', 'X', 'X'}},
       ...
       {"CP Function Features",			   'C', {'X', 'X', 'X', 'X'}},
       {"User Plane IP Resource Information",	   'O', {'X', 'X', 'X', 'X'}},
       {"UE IP address Pool Identity",		   'O', {'X', 'X', 'X', 'X'}},
	...
	[{"MAR ID",				   'M', {'-', '-', '-', 'X'}},
	 ...
	 {"Steering Mode",			   'M', {'-', '-', '-', 'X'}},
	 {"Access Forwarding Action Information 1",		'C', {'-', '-', '-', 'X'},
	  [{"FAR ID",				   'M', {'-', '-', '-', 'X'}},
	   {"Weight",				   'C', {'-', '-', '-', 'X'}},
	   {"Priority",				   'C', {'-', '-', '-', 'X'}},
	   {"URR ID",				   'C', {'-', '-', '-', 'X'}}]},
	 {"Access Forwarding Action Information 2",		'C', {'-', '-', '-', 'X'},
	  [{"FAR ID",				   'M', {'-', '-', '-', 'X'}},
	   {"Weight",				   'C', {'-', '-', '-', 'X'}},
	   {"Priority",				   'C', {'-', '-', '-', 'X'}},
	   {"URR ID",				   'C', {'-', '-', '-', 'X'}}]}
	...
	[{"MAR ID",				   'M', {'-', '-', '-', 'X'}},
	 ...
	 {"Steering Mode",			   'C', {'-', '-', '-', 'X'}},
	 {"Update Access Forwarding Action Information 1",	'C', {'-', '-', '-', 'X'},
	  [{"FAR ID",				   'C', {'-', '-', '-', 'X'}},
	   {"Weight",				   'C', {'-', '-', '-', 'X'}},
	   {"Priority",				   'C', {'-', '-', '-', 'X'}},
	   {"URR ID",				   'C', {'-', '-', '-', 'X'}}]},
	 {"Update Access Forwarding Action Information 2",	'C', {'-', '-', '-', 'X'},
	  [{"FAR ID",				   'C', {'-', '-', '-', 'X'}},
	   {"Weight",				   'C', {'-', '-', '-', 'X'}},
	   {"Priority",				   'C', {'-', '-', '-', 'X'}},
	   {"URR ID",				   'C', {'-', '-', '-', 'X'}}]},
	...
	[{"MAR ID",				   'M', {'-', '-', '-', 'X'}},
	 {"Steering Functionality",		   'M', {'-', '-', '-', 'X'}},
	 {"Steering Mode",			   'M', {'-', '-', '-', 'X'}},
	 {"Access Forwarding Action Information 1",		'M', {'-', '-', '-', 'X'},
	  [{"FAR ID",				   'M', {'-', '-', '-', 'X'}},
	   {"Weight",				   'C', {'-', '-', '-', 'X'}},
	   {"Priority",				   'C', {'-', '-', '-', 'X'}},
	   {"URR ID",				   'C', {'-', '-', '-', 'X'}}]},
	 {"Access Forwarding Action Information 2",		'M', {'-', '-', '-', 'X'},
	  [{"FAR ID",				   'M', {'-', '-', '-', 'X'}},
	   {"Weight",				   'C', {'-', '-', '-', 'X'}},
	   {"Priority",				   'C', {'-', '-', '-', 'X'}},
	   {"URR ID",				   'C', {'-', '-', '-', 'X'}}]}
